<?php
	...
	/* Area occurred */			if (($templateName == 'rumour_add' && !$matchingRumour) || ($templateName == 'rumour_edit' && $logged_in['is_administrator'] && $logged_in['can_edit_content'])) {
									...
									if ($templateName == 'rumour_edit') {
										...
										echo "  <div class='row'>\n";
										echo "    <div class='col-md-6'>" . $form->input('text', 'latitude', $operators->firstTrue(@$_POST['latitude'], (@$rumour[0]['latitude'] <> 0 ? $rumour[0]['latitude'] : false)), false, '|Latitude', 'form-control', null, 11) . "</div>\n";
										echo "    <div class='col-md-6'>" . $form->input('text', 'longitude', $operators->firstTrue(@$_POST['longitude'], (@$rumour[0]['longitude'] <> 0 ? $rumour[0]['longitude'] : false)), false, '|Longitude', 'form-control', null, 11) . "</div>\n";
										echo "  </div>\n";
										echo $form->rowEnd();
									}
								}
