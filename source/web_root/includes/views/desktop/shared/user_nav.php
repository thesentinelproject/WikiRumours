<?php
	...
	if (@$logged_in) {
		// My Rumours
			...
			if ($tl->page['template'] == 'my_rumours') echo " verticalPillActive";
			echo "'><a href='/my_rumours' class='";
			if ($tl->page['template'] == 'my_rumours') echo "pillActive";
			else echo "pillInactive";
			echo "'>My Rumours</a></li>\n";
		// My Watchlist
			echo "            <li class='hideBullets";
			if ($tl->page['template'] == 'watchlist') echo " verticalPillActive";
			echo "'><a href='/watchlist' class='";
			if ($tl->page['template'] == 'watchlist') echo "pillActive";
			else echo "pillInactive";
			echo "'>My Watchlist</a></li>\n";
		// Profile
			echo "            <li class='dropdown hideBullets";
			if ($tl->page['section'] == 'Profile' || $tl->page['section'] == 'Administration') echo " verticalPillActive";
			echo "'>\n";
			echo "              <a class='dropdown-toggle ";
			if ($tl->page['section'] == 'Profile' || $tl->page['section'] == 'Administration') echo "pillActive";
			else echo "pillInactive";
			echo "' data-toggle='dropdown' href='#'>My Profile <b class='caret'></b></a>\n";
			echo "              <ul class='dropdown-menu'>\n";
		// Me
			echo "                <li class='hideBullets";
			if ($tl->page['template'] == 'profile') echo " pillActive";
		...
		// Obtain API key
			...
			if ($logged_in['is_administrator']) {
				// Administration
					...
					// Dashboard
						echo "                <li class='hideBullets";
						if ($tl->page['template'] == 'admin_dashboard') echo " pillActive";
					...
					// Settings
						if ($logged_in['can_update_settings'] || $logged_in['can_edit_settings']) {
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'admin_settings') echo " pillActive";
							echo "'><a href='/admin_settings'><span class='glyphicon glyphicon-cog transluscent'></span> &nbsp; Settings</a></li>\n";
						}
					// Security
						if ($logged_in['can_update_settings'] || $logged_in['can_edit_settings']) {
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'admin_security') echo " pillActive";
							echo "'><a href='/admin_security'><span class='glyphicon glyphicon-tower transluscent'></span> &nbsp; Security</a></li>\n";
						}
					// Users
						if ($logged_in['can_edit_users']) {
							echo "                  <li role='presentation' class='hideBullets";
							if ($tl->page['template'] == 'admin_users') echo " active";
							echo "'><a href='/admin_users'><span class='glyphicon glyphicon-hand-up transluscent'></span> &nbsp; Users</a></li>\n";
							echo "                  <li role='presentation' class='hideBullets";
							if ($tl->page['template'] == 'admin_duplicate_users') echo " active";
							echo "'><a href='/admin_duplicate_users'><span class='glyphicon glyphicon-duplicate transluscent'></span> &nbsp; Duplicate Users</a></li>\n";
						}
					// Email
						echo "                  <li role='presentation' class='hideBullets";
						if ($tl->page['template'] == 'admin_email') echo " active";
						echo "'><a href='/admin_email'><span class='glyphicon glyphicon-envelope transluscent'></span> &nbsp; Email</a></li>\n";
					// Pseudonyms
						echo "                <li class='hideBullets";
						if ($tl->page['template'] == 'admin_pseudonyms') echo " pillActive";
						echo "'><a href='/admin_pseudonyms'><span class='glyphicon glyphicon-globe transluscent'></span> &nbsp; Pseudonyms</a></li>\n";
					// Logs
						echo "                <li class='hideBullets";
						if ($tl->page['template'] == 'admin_logs') echo " pillActive";
					...
					// Housekeeping
						if ($logged_in['can_run_housekeeping']) {
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'housekeeping') echo " pillActive";
				...
				// Content
					if ($logged_in['can_edit_content']) {
						...
						// CMS
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'admin_content') echo " pillActive";
							echo "'><a href='/admin_content'><span class='glyphicon glyphicon-edit transluscent'></span> &nbsp; CMS</a></li>\n";
						// FAQs
							echo "                  <li role='presentation' class='hideBullets";
							if ($tl->page['template'] == 'admin_faqs') echo " active";
				...
				// Rumour management
					...
					// Rumours
						echo "                <li class='hideBullets";
						if ($tl->page['template'] == 'admin_rumours') echo " pillActive";
					...
					if ($logged_in['can_edit_settings']) {
						// Priorities
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'admin_priorities') echo " pillActive";
							echo "'><a href='/admin_priorities'><span class='glyphicon glyphicon-sort transluscent'></span> &nbsp; Priorities</a></li>\n";
						// Statuses
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'admin_statuses') echo " pillActive";
				...
				// Testing
					if ($logged_in['is_tester']) {
						...
						// Sandbox
							echo "                <li class='hideBullets";
							if ($tl->page['template'] == 'sandbox') echo " pillActive";
		...
		if ($tl->page['template'] == 'login_register') echo " class='pillActive'";
