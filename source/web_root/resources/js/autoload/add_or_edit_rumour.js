	...
	function validateAddEditRumourForm() {
		...
		if (document.addEditRumourForm.templateName.value == 'rumour_add') {
			...
			if (!document.addEditRumourForm.status_id.value) errorMessage += "Please specify a status.\n";
			...
			if (!document.addEditRumourForm.heard_by.value) errorMessage += "Please specify who heard the rumour.\n";
